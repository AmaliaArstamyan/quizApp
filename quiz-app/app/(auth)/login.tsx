    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.title}>Բարի վերադարձ</Text>
          <Text style={styles.subtitle}>Մուտք գործեք ձեր հաշիվ</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <GradientButton title="Մուտք" onPress={onSubmit} loading={loading} />

          <Link href="/(auth)/register" asChild>
            <Pressable style={styles.linkWrapper}>
              <Text style={styles.linkMuted}>Հաշիվ չունե՞ք։</Text>
              <Text style={styles.link}> Գրանցվեք</Text>
            </Pressable>
          </Link>
        </View>
      </ScrollView>
